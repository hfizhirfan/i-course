    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              <li class="nav-item">
                <a href="{{ route('home') }}" class="nav-link custom-nav-link @if ($currentRouteName == 'index') active @endif">Beranda</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="#" class="dropdown-item">Bahasa</a></li>
                  <li><a href="#" class="dropdown-item">Sains dan Matematika</a></li>
                  <li><a href="#" class="dropdown-item">Pengembangan Personal</a></li>
                  <li><a href="#" class="dropdown-item">Desain</a></li>
                  <li><a href="{{ route('category.index') }}" class="dropdown-item">Bahasa Pemrograman</a></li>
                  <li><a href="#" class="dropdown-item">Jaringan dan Keamanan</a></li>
                  <li><a href="#" class="dropdown-item">Pemasaran</a></li>
                  <li><a href="#" class="dropdown-item">Keuangan dan Akuntansi</a></li>
                </ul>
              </li>
              <li class="nav-item">
