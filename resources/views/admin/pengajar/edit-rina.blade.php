    ...
    <div class="card">
        <div class="row g-3">
            <div class="col-md-6 d-flex align-items-center">
                ...
                <input type="text" class="form-control" id="userId" placeholder="Masukkan nama" value="Rina Wijaya, S.Pd.">
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Nomor Telepon</label>
                <input type="text" class="form-control" id="userId" placeholder="Masukkan nomor telepon" value="0812 3456 7890">
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Keahlian</label>
                <input type="text" class="form-control" id="phone" placeholder="Masukkan keahlian" value="Spesialis Linguistik Bahasa Indonesia">
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Email</label>
                <input type="email" class="form-control" id="email" placeholder="Masukkan email" value="rinawijaya@email.com">
            </div>
            ...
            <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="file-input-wrapper">
                    ...
                    <span id="fileName">Rina.png</span>
                </div>
            </div>
            <div class="col-md-6 d-flex align-items-center">
