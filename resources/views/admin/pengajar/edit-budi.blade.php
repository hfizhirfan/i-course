    ...
    <div class="card">
        <div class="row g-3">
            <div class="col-md-6 d-flex align-items-center">
                ...
                <input type="text" class="form-control" id="userId" placeholder="Masukkan nama" value="Dr. Budi Setiawan, M.Si.">
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Nomor Telepon</label>
                <input type="text" class="form-control" id="userId" placeholder="Masukkan nomor telepon" value="0852 1234 5678">
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Keahlian</label>
                <input type="text" class="form-control" id="phone" placeholder="Masukkan keahlian" value="Biologi Molekuler">
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Email</label>
                <input type="email" class="form-control" id="email" placeholder="Masukkan email" value="boodie@email.com">
            </div>
            <div class="col-12 d-flex align-items-center">
                <label for="deskripsi" class="form-label me-3">Deskripsi</label>
                <textarea class="form-text" id="deskripsi" rows="4" placeholder="Masukkan deskripsi">Ahli Biologi Molekuler yang berpengalaman dalam penelitian genetika dan eksplorasi mutasi genetik.</textarea>
            </div>
            <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="file-input-wrapper">
                    ...
                    <span id="fileName">Budi Setiawan.png</span>
                </div>
            </div>
            <div class="col-md-6 d-flex align-items-center">
