...
<div class="container my-3">
    <h2 class="header-title mb-4">Detail Pengajar</h2>
    <div class="card">
        <div class="row g-3">
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Nama Lengkap</label>
                <input type="text" class="form-control" id="userId" placeholder="Masukkan nama" value="Dr. Budi Setiawan, M.Si." readonly>
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Nomor Telepon</label>
                <input type="text" class="form-control" id="userId" placeholder="Masukkan nomor telepon" value="0852 1234 5678"readonly>
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Keahlian</label>
                <input type="text" class="form-control" id="phone" placeholder="Masukkan keahlian" value="Biologi Molekuler"readonly>
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Email</label>
                <input type="email" class="form-control" id="email" placeholder="Masukkan email" value="boodie@email.com" readonly>
            </div>
            <div class="col-12 d-flex align-items-center">
                <label for="deskripsi" class="form-label me-3">Deskripsi</label>
                <textarea class="form-text" id="deskripsi" rows="4" placeholder="Masukkan deskripsi" readonly>Ahli Biologi Molekuler yang berpengalaman dalam penelitian genetika dan eksplorasi mutasi genetik.</textarea>
            </div>
            <div class="col-md-6 d-flex align-items-center">
                ...
                <div id="photoPopup" class="popup">
                    <div class="popup-content">
                        ...
                        <img src="{{ Vite::asset('resources/images/budi.png') }}" alt="Foto Budiono Siregar">
                    </div>
                </div>
            </div>
            <div class="col-md-6 d-flex align-items-center">
