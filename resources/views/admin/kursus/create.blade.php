...
<div class="search-container">
    <div class="container search d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center">
            <!-- Tombol Pengaturan -->
            <a href="{{ route('admin.kursus.setting-tambah') }}" class="btn btn-link d-flex align-items-center me-2">
...
<div class="container my-3">
    <h2 class="header-title mb-4">Tambah Kursus</h2>
    <div class="card">
        <form>
            <div class="d-flex align-items-center mb-4">
                ...
                <select class="form-select adjust-select" id="category">
                    ...
                    <option>Pengembangan Personal</option>
                    <option>Desain</option>
                    <option>Bahasa Pemrograman</option>
                    <option>Jaringan dan Keamanan</option>
                    <option>Pemasaran</option>
                    <option>Keuangan dan Akutansi</option>
            ...
            <div class="d-flex align-items-start mb-4 custom-div">
                ...
                <textarea class="form-control custom-textarea" id="shortDesc" rows="3" placeholder="Masukkan penjelasan"></textarea>
            ...
            <div class="d-flex align-items-start mb-4">
                ...
                <!-- Textarea -->
                <textarea class="form-control description-textarea" id="description" rows="4" placeholder="Masukkan deskripsi"></textarea>
            ...
            <div class="d-flex align-items-start mb-4">
                ...
                <!-- Input Fields -->
                <div class="w-100" id="teachingPointsContainer">
                    <div class="d-flex align-items-center mb-2">
                        <input type="text" class="form-control teaching-point-input" placeholder="Masukkan poin-poin" />
                    </div>
                ...
                <div class="d-flex gap-3">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu custom-dropdown-menu" aria-labelledby="dropdownTalent1">
                            <li><a class="dropdown-item custom-dropdown-item" href="#">Alexander</a></li>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu custom-dropdown-menu" aria-labelledby="dropdownTalent2">
                            <li><a class="dropdown-item custom-dropdown-item" href="#">Richardo</a></li>
...
.notification-popup .isi-content {
    font-size: 14px;
    font-weight: 600;
    color: #464F60;
    text-align: center;
...
.custom-button {
    width: 200px;
    background-color: #475569; /* Warna tombol */
    color: white;
    border-radius: 20px;
    padding: 6px 16px;
    display: flex;
...
.text-tugas {
  ...
  overflow: hidden; /* Menyembunyikan scrollbar */
    resize: none; /* Menonaktifkan resizing manual */
    border: 1px solid #aeaeae; /* Warna border diubah */
}
...
.centered-col {
    ...
    justify-content: center;
    align-items: center;
    height: 100%; /* Pastikan elemen parent memiliki tinggi yang ditentukan */
}

.teaching-point-delete {
    background-color: transparent; /* Buat tombol transparan */
    border: none; /* Hapus border */
    color: #4A5568; /* Warna ikon */
    padding: 0.5rem; /* Tambahkan sedikit ruang */
    cursor: pointer; /* Ubah kursor menjadi pointer */
}

.teaching-point-delete:hover {
    color: #2D3748; /* Warna saat hover */
}
...
document.querySelector('.teaching-point-add').addEventListener('click', function () {
    // Container tempat input baru akan ditambahkan
    const container = document.getElementById('teachingPointsContainer');

    // Buat elemen wrapper untuk input dan tombol delete
    ...
    newInput.type = 'text';
    newInput.className = 'form-control teaching-point-input';
    newInput.placeholder = 'Masukkan poin-poin';

    // Buat tombol delete dengan ikon
    const deleteButton = document.createElement('button');
    deleteButton.type = 'button';
    deleteButton.className = 'btn btn-icon teaching-point-delete';
    deleteButton.innerHTML = '<i class="bi bi-trash3-fill"></i>'; // Gunakan ikon Bootstrap
    ...
    // Tambahkan input dan tombol delete ke dalam wrapper
    inputWrapper.appendChild(newInput);
    inputWrapper.appendChild(deleteButton);

    // Tambahkan wrapper ke dalam container
    container.insertBefore(inputWrapper, this); // Tambahkan sebelum tombol "Tambah"
});
...
// Menangani tombol "Simpan" (contoh jika digunakan)
document.getElementById('saveButton')?.addEventListener('click', function (event) {
    event.preventDefault(); // Mencegah pengalihan halaman langsung
    showNotification();

    // Simulasi pengalihan halaman setelah notifikasi muncul
    setTimeout(function () {
        window.location.href = "{{ route('admin.kursus.index') }}"; // Ganti dengan URL Anda
    }, 1500); // Tunggu 1.5 detik sebelum pindah halaman
});

// Fungsi untuk memperbarui nama file yang dipilih (opsional)
