...
<div class="search-container">
    <div class="container search d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center">
            <!-- Tombol Pengaturan -->
            <a href="{{ route('admin.soal.setting-edit') }}" class="btn btn-link d-flex align-items-center me-2">
...
<div class="container my-3">
    <h2 class="header-title mb-4">Edit Soal</h2>
    <div id="question-container">
        <div class="card mb-3">
                ...
                <div class="question-row">
                    ...
                    <div class="textarea-container" data-group="1">
                    ...
                    <div class="question-options">
                        ...
                        <div class="question-type-container">
                            <button id="dropdown-toggle-1" class="dropdown-toggle" style="border: 1px solid #ccc;">
                        ...
                        <div class="points-container">
                            ...
                            <input type="number" id="points" class="form-control" style="width: 80px;" value="10" min="0" value="0">
                        </div>
                    </div>

                </div>
                <!-- Jawaban -->
                <div class="answers-container" id="multiple-choice-1" data-extra-id="multiple-choice-1" style="display: block; margin-top: 20px;" data-answer-index="4">
                        ...
                        <!-- Answer Group -->
                            <div class="answer-input-group d-flex align-items-center mb-2">
                                ...
                                <div class="input-wrapper position-relative">
                                    <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Char">
                            ...
                            <div class="answer-input-group d-flex align-items-center mb-2">
                                ...
                                <div class="input-wrapper position-relative">
                                    <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="String">
                                    <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                        <!-- Ikon Upload -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                            <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                            ...
                            <div class="answer-input-group d-flex align-items-center mb-2">
                                ...
                                <label class="answer-label me-2">C.</label>
                                <div class="input-wrapper position-relative">
                                    <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Array">
                                    <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                        <!-- Ikon Upload -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                            <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                            ...
                            <div class="answer-input-group d-flex align-items-center mb-2">
                                ...
                                <label class="answer-label me-2">D.</label>
                                <div class="input-wrapper position-relative">
                                    <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Integer">
                                    <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                        <!-- Ikon Upload -->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                            <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                    ...
                    <div class="container mt-3">
                        <div>
                            <button class="btn add-answer-btn" onclick="addAnswer('answers-container-1', 'multiple-choice-1')" id="add-answer-button" >
                ...
                <div class="answers-container" id="essay-1" style="display: none;">
        ...
        <div class="card mb-3">
            ...
            <div class="question-row">
                <!-- Nomor Pertanyaan -->
                <label class="question-number">2.</label>

                <div class="textarea-container" data-group="2">
                    <textarea class="form-control question-textarea" rows="4" placeholder="Masukkan pertanyaan">Apa fungsi dari `System.out.println("Hello, World!");` di Java?</textarea>
                    <div id="imagePreviewContainer"
                        class="image-preview-container"
                        style="
                            position: absolute;
            ...
            <!-- Jawaban -->
            <div class="answers-container" id="multiple-choice-2" data-extra-id="multiple-choice-2" style="display: block; margin-top: 20px;" data-answer-index="4">
                <div id="answers-container-2">
                    <!-- Answer Group -->
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">A.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Menghentikan program">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">B.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Menjalankan program">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">C.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Membaca dari data pengguna">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">D.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Menampilkan text 'Hello, World!' ke layar">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                ...
                <div class="container mt-3">
                    <div>
                        <button class="btn add-answer-btn" onclick="addAnswer('answers-container-2', 'multiple-choice-2')" id="add-answer-button" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="add-answer-icon">
                                <path d="M9.28125 7.46875V0.25H7.21875V7.46875H0V9.53125H7.21875V16.75H9.28125V9.53125H16.5V7.46875H9.28125Z" fill="#0056D2"/>
                            </svg>
                            <span class="add-answer-text">Tambah jawaban</span>
            ...
            <div class="answers-container" id="essay-2" style="display: none;">
                <textarea class="form-control textarea-jawaban" placeholder="Masukkan jawaban"></textarea>
            </div>
        </div>
        <div class="card mb-3">
            ...
            <div class="question-row">
                <!-- Nomor Pertanyaan -->
                <label class="question-number">3.</label>

                <div class="textarea-container" data-group="3">
                    <textarea class="form-control question-textarea" rows="4" placeholder="Masukkan pertanyaan">Apa fungsi utama dari JDK dalam pengembangan aplikasi Java?</textarea>
                    <div id="imagePreviewContainer"
                        class="image-preview-container"
                        style="
                            position: absolute;
                ...
                <div class="question-options">
                    <!-- Dropdown Pilihan Ganda / Esai -->
                    <div class="question-type-container">
                        <button id="dropdown-toggle-3" class="dropdown-toggle" style="border: 1px solid #ccc;">
                            <span class="dropdown-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    <path d="M2.64062 9.99984C2.64062 14.6023 6.37146 18.3332 10.974 18.3332C15.5765 18.3332 19.3073 14.6023 19.3073 9.99984C19.3073 5.39734 15.5765 1.6665 10.974 1.6665C6.37146 1.6665 2.64062 5.39734 2.64062 9.99984ZM17.6406 9.99984C17.6406 11.7679 16.9382 13.4636 15.688 14.7139C14.4378 15.9641 12.7421 16.6665 10.974 16.6665C9.20585 16.6665 7.51016 15.9641 6.25991 14.7139C5.00967 13.4636 4.30729 11.7679 4.30729 9.99984C4.30729 8.23173 5.00967 6.53603 6.25991 5.28579C7.51016 4.03555 9.20585 3.33317 10.974 3.33317C12.7421 3.33317 14.4378 4.03555 15.688 5.28579C16.9382 6.53603 17.6406 8.23173 17.6406 9.99984ZM10.974 14.9998C12.3 14.9998 13.5718 14.4731 14.5095 13.5354C15.4472 12.5977 15.974 11.3259 15.974 9.99984C15.974 8.67375 15.4472 7.40199 14.5095 6.4643C13.5718 5.52662 12.3 4.99984 10.974 4.99984C9.64788 4.99984 8.37611 5.52662 7.43842 6.4643C6.50074 7.40199 5.97396 8.67375 5.97396 9.99984C5.97396 11.3259 6.50074 12.5977 7.43842 13.5354C8.37611 14.4731 9.64788 14.9998 10.974 14.9998Z" fill="black" />
                                </svg>
            ...
            <!-- Jawaban -->
            <div class="answers-container" id="multiple-choice-3" data-extra-id="multiple-choice-3" style="display: block; margin-top: 20px;" data-answer-index="4">
                <div id="answers-container-3">
                    <!-- Answer Group -->
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">A.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Menyediakan alat untuk debugging.">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">B.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Mengompilasi dan menjalankan program Java.">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">C.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Menyimpan data aplikasi Java.">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">D.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Mengelola memori aplikasi Java.">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                ...
                <div class="container mt-3">
                    <div>
                        <button class="btn add-answer-btn"  onclick="addAnswer('answers-container-3', 'multiple-choice-3')" id="add-answer-button" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="add-answer-icon">
                                <path d="M9.28125 7.46875V0.25H7.21875V7.46875H0V9.53125H7.21875V16.75H9.28125V9.53125H16.5V7.46875H9.28125Z" fill="#0056D2"/>
                            </svg>
                            <span class="add-answer-text">Tambah jawaban</span>
            ...
            <div class="answers-container" id="essay-3" style="display: none;">
                <textarea class="form-control textarea-jawaban" placeholder="Masukkan jawaban"></textarea>
            </div>
        </div>
        <div class="card mb-3">
            ...
            <div class="question-row">
                <!-- Nomor Pertanyaan -->
                <label class="question-number">4.</label>

                <div class="textarea-container" data-group="4">
                    <textarea class="form-control question-textarea" rows="4" placeholder="Masukkan pertanyaan">Mana di antara nama variabel berikut yang **tidak valid** di Java?</textarea>
                    <div id="imagePreviewContainer"
                        class="image-preview-container"
                        style="
                            position: absolute;
                ...
                <div class="question-options">
                    <!-- Dropdown Pilihan Ganda / Esai -->
                    <div class="question-type-container">
                        <button id="dropdown-toggle-4" class="dropdown-toggle" style="border: 1px solid #ccc;">
                            <span class="dropdown-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    <path d="M2.64062 9.99984C2.64062 14.6023 6.37146 18.3332 10.974 18.3332C15.5765 18.3332 19.3073 14.6023 19.3073 9.99984C19.3073 5.39734 15.5765 1.6665 10.974 1.6665C6.37146 1.6665 2.64062 5.39734 2.64062 9.99984ZM17.6406 9.99984C17.6406 11.7679 16.9382 13.4636 15.688 14.7139C14.4378 15.9641 12.7421 16.6665 10.974 16.6665C9.20585 16.6665 7.51016 15.9641 6.25991 14.7139C5.00967 13.4636 4.30729 11.7679 4.30729 9.99984C4.30729 8.23173 5.00967 6.53603 6.25991 5.28579C7.51016 4.03555 9.20585 3.33317 10.974 3.33317C12.7421 3.33317 14.4378 4.03555 15.688 5.28579C16.9382 6.53603 17.6406 8.23173 17.6406 9.99984ZM10.974 14.9998C12.3 14.9998 13.5718 14.4731 14.5095 13.5354C15.4472 12.5977 15.974 11.3259 15.974 9.99984C15.974 8.67375 15.4472 7.40199 14.5095 6.4643C13.5718 5.52662 12.3 4.99984 10.974 4.99984C9.64788 4.99984 8.37611 5.52662 7.43842 6.4643C6.50074 7.40199 5.97396 8.67375 5.97396 9.99984C5.97396 11.3259 6.50074 12.5977 7.43842 13.5354C8.37611 14.4731 9.64788 14.9998 10.974 14.9998Z" fill="black" />
                                </svg>
                        ...
                        <ul id="dropdown-menu-4" class="dropdown-menu">
                            <li data-value="multiple-choice" data-icon='
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    <path d="M2.64062 9.99984C2.64062 14.6023 6.37146 18.3332 10.974 18.3332C15.5765 18.3332 19.3073 14.6023 19.3073 9.99984C19.3073 5.39734 15.5765 1.6665 10.974 1.6665C6.37146 1.6665 2.64062 5.39734 2.64062 9.99984ZM17.6406 9.99984C17.6406 11.7679 16.9382 13.4636 15.688 14.7139C14.4378 15.9641 12.7421 16.6665 10.974 16.6665C9.20585 16.6665 7.51016 15.9641 6.25991 14.7139C5.00967 13.4636 4.30729 11.7679 4.30729 9.99984C4.30729 8.23173 5.00967 6.53603 6.25991 5.28579C7.51016 4.03555 9.20585 3.33317 10.974 3.33317C12.7421 3.33317 14.4378 4.03555 15.688 5.28579C16.9382 6.53603 17.6406 8.23173 17.6406 9.99984ZM10.974 14.9998C12.3 14.9998 13.5718 14.4731 14.5095 13.5354C15.4472 12.5977 15.974 11.3259 15.974 9.99984C15.974 8.67375 15.4472 7.40199 14.5095 6.4643C13.5718 5.52662 12.3 4.99984 10.974 4.99984C9.64788 4.99984 8.37611 5.52662 7.43842 6.4643C6.50074 7.40199 5.97396 8.67375 5.97396 9.99984C5.97396 11.3259 6.50074 12.5977 7.43842 13.5354C8.37611 14.4731 9.64788 14.9998 10.974 14.9998Z" fill="black"/>
                                </svg>'>
            ...
            <!-- Jawaban -->
            <div class="answers-container" id="multiple-choice-4" data-extra-id="multiple-choice-4" style="display: block; margin-top: 20px;" data-answer-index="4">
                <div id="answers-container-4">
                    <!-- Answer Group -->
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">A.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value=" `namaPengguna` ">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">B.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value=" `_totalNilai` ">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">C.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value=" `3hasil` ">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">D.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value=" `jumlahMaksimum` ">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                ...
                <div class="container mt-3">
                    <div>
                        <button class="btn add-answer-btn" onclick="addAnswer('answers-container-4', 'multiple-choice-4')" id="add-answer-button" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="add-answer-icon">
                                <path d="M9.28125 7.46875V0.25H7.21875V7.46875H0V9.53125H7.21875V16.75H9.28125V9.53125H16.5V7.46875H9.28125Z" fill="#0056D2"/>
                            </svg>
                            <span class="add-answer-text">Tambah jawaban</span>
            ...
            <div class="answers-container" id="essay-4" style="display: none;">
                <textarea class="form-control textarea-jawaban" placeholder="Masukkan jawaban"></textarea>
            </div>
        </div>
        <div class="card mb-3">
            ...
            <div class="question-row">
                <!-- Nomor Pertanyaan -->
                <label class="question-number">5.</label>

                <div class="textarea-container" data-group="5">
                    <textarea class="form-control question-textarea" rows="4" placeholder="Masukkan pertanyaan">Apa peran utama metode public static void main(String[] args) di Java?</textarea>
                    <div id="imagePreviewContainer"
                        class="image-preview-container"
                        style="
                            position: absolute;
                ...
                <div class="question-options">
                    <!-- Dropdown Pilihan Ganda / Esai -->
                    <div class="question-type-container">
                        <button id="dropdown-toggle-5" class="dropdown-toggle" style="border: 1px solid #ccc;">
                            <span class="dropdown-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    <path d="M2.64062 9.99984C2.64062 14.6023 6.37146 18.3332 10.974 18.3332C15.5765 18.3332 19.3073 14.6023 19.3073 9.99984C19.3073 5.39734 15.5765 1.6665 10.974 1.6665C6.37146 1.6665 2.64062 5.39734 2.64062 9.99984ZM17.6406 9.99984C17.6406 11.7679 16.9382 13.4636 15.688 14.7139C14.4378 15.9641 12.7421 16.6665 10.974 16.6665C9.20585 16.6665 7.51016 15.9641 6.25991 14.7139C5.00967 13.4636 4.30729 11.7679 4.30729 9.99984C4.30729 8.23173 5.00967 6.53603 6.25991 5.28579C7.51016 4.03555 9.20585 3.33317 10.974 3.33317C12.7421 3.33317 14.4378 4.03555 15.688 5.28579C16.9382 6.53603 17.6406 8.23173 17.6406 9.99984ZM10.974 14.9998C12.3 14.9998 13.5718 14.4731 14.5095 13.5354C15.4472 12.5977 15.974 11.3259 15.974 9.99984C15.974 8.67375 15.4472 7.40199 14.5095 6.4643C13.5718 5.52662 12.3 4.99984 10.974 4.99984C9.64788 4.99984 8.37611 5.52662 7.43842 6.4643C6.50074 7.40199 5.97396 8.67375 5.97396 9.99984C5.97396 11.3259 6.50074 12.5977 7.43842 13.5354C8.37611 14.4731 9.64788 14.9998 10.974 14.9998Z" fill="black" />
                                </svg>
                        ...
                        <ul id="dropdown-menu-5" class="dropdown-menu">
                            <li data-value="multiple-choice" data-icon='
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    <path d="M2.64062 9.99984C2.64062 14.6023 6.37146 18.3332 10.974 18.3332C15.5765 18.3332 19.3073 14.6023 19.3073 9.99984C19.3073 5.39734 15.5765 1.6665 10.974 1.6665C6.37146 1.6665 2.64062 5.39734 2.64062 9.99984ZM17.6406 9.99984C17.6406 11.7679 16.9382 13.4636 15.688 14.7139C14.4378 15.9641 12.7421 16.6665 10.974 16.6665C9.20585 16.6665 7.51016 15.9641 6.25991 14.7139C5.00967 13.4636 4.30729 11.7679 4.30729 9.99984C4.30729 8.23173 5.00967 6.53603 6.25991 5.28579C7.51016 4.03555 9.20585 3.33317 10.974 3.33317C12.7421 3.33317 14.4378 4.03555 15.688 5.28579C16.9382 6.53603 17.6406 8.23173 17.6406 9.99984ZM10.974 14.9998C12.3 14.9998 13.5718 14.4731 14.5095 13.5354C15.4472 12.5977 15.974 11.3259 15.974 9.99984C15.974 8.67375 15.4472 7.40199 14.5095 6.4643C13.5718 5.52662 12.3 4.99984 10.974 4.99984C9.64788 4.99984 8.37611 5.52662 7.43842 6.4643C6.50074 7.40199 5.97396 8.67375 5.97396 9.99984C5.97396 11.3259 6.50074 12.5977 7.43842 13.5354C8.37611 14.4731 9.64788 14.9998 10.974 14.9998Z" fill="black"/>
                                </svg>'>
            ...
            <!-- Jawaban -->
            <div class="answers-container" id="multiple-choice-5" data-extra-id="multiple-choice-5" style="display: block; margin-top: 20px;" data-answer-index="4">
                <div id="answers-container-5">
                    <!-- Answer Group -->
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            <button class="btn status-button me-2" onclick="toggleAnswerStatus(this)" style="border: none;">
                                 <!-- Ikon SVG Silang -->
                            ...
                            <label class="answer-label me-2">A.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Menyimpan data variabel.">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">B.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Sebagai titik awal eksekusi program.">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">C.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Menampilkan teks ke layar.">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">D.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Mengkompilasi program.">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                ...
                <div class="container mt-3">
                    <div>
                        <button class="btn add-answer-btn" onclick="addAnswer('answers-container-5', 'multiple-choice-5')" id="add-answer-button" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="add-answer-icon">
                                <path d="M9.28125 7.46875V0.25H7.21875V7.46875H0V9.53125H7.21875V16.75H9.28125V9.53125H16.5V7.46875H9.28125Z" fill="#0056D2"/>
                            </svg>
                            <span class="add-answer-text">Tambah jawaban</span>
            ...
            <div class="answers-container" id="essay-5" style="display: none;">
                <textarea class="form-control textarea-jawaban" placeholder="Masukkan jawaban"></textarea>
            </div>
        </div>
        <div class="card mb-3">
            ...
            <div class="question-row">
                <!-- Nomor Pertanyaan -->
                <label class="question-number">6.</label>

                <div class="textarea-container" data-group="1">
                    <textarea class="form-control question-textarea" rows="4" placeholder="Masukkan pertanyaan">Tipe data mana yang digunakan untuk menyimpan bilangan pecahan?</textarea>
                    <div id="imagePreviewContainer"
                        class="image-preview-container"
                        style="
                            position: absolute;
                ...
                <div class="question-options">
                    <!-- Dropdown Pilihan Ganda / Esai -->
                    <div class="question-type-container">
                        <button id="dropdown-toggle-6" class="dropdown-toggle" style="border: 1px solid #ccc;">
                            <span class="dropdown-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    <path d="M2.64062 9.99984C2.64062 14.6023 6.37146 18.3332 10.974 18.3332C15.5765 18.3332 19.3073 14.6023 19.3073 9.99984C19.3073 5.39734 15.5765 1.6665 10.974 1.6665C6.37146 1.6665 2.64062 5.39734 2.64062 9.99984ZM17.6406 9.99984C17.6406 11.7679 16.9382 13.4636 15.688 14.7139C14.4378 15.9641 12.7421 16.6665 10.974 16.6665C9.20585 16.6665 7.51016 15.9641 6.25991 14.7139C5.00967 13.4636 4.30729 11.7679 4.30729 9.99984C4.30729 8.23173 5.00967 6.53603 6.25991 5.28579C7.51016 4.03555 9.20585 3.33317 10.974 3.33317C12.7421 3.33317 14.4378 4.03555 15.688 5.28579C16.9382 6.53603 17.6406 8.23173 17.6406 9.99984ZM10.974 14.9998C12.3 14.9998 13.5718 14.4731 14.5095 13.5354C15.4472 12.5977 15.974 11.3259 15.974 9.99984C15.974 8.67375 15.4472 7.40199 14.5095 6.4643C13.5718 5.52662 12.3 4.99984 10.974 4.99984C9.64788 4.99984 8.37611 5.52662 7.43842 6.4643C6.50074 7.40199 5.97396 8.67375 5.97396 9.99984C5.97396 11.3259 6.50074 12.5977 7.43842 13.5354C8.37611 14.4731 9.64788 14.9998 10.974 14.9998Z" fill="black" />
                                </svg>
                        ...
                        <ul id="dropdown-menu-6" class="dropdown-menu">
                            <li data-value="multiple-choice" data-icon='
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    <path d="M2.64062 9.99984C2.64062 14.6023 6.37146 18.3332 10.974 18.3332C15.5765 18.3332 19.3073 14.6023 19.3073 9.99984C19.3073 5.39734 15.5765 1.6665 10.974 1.6665C6.37146 1.6665 2.64062 5.39734 2.64062 9.99984ZM17.6406 9.99984C17.6406 11.7679 16.9382 13.4636 15.688 14.7139C14.4378 15.9641 12.7421 16.6665 10.974 16.6665C9.20585 16.6665 7.51016 15.9641 6.25991 14.7139C5.00967 13.4636 4.30729 11.7679 4.30729 9.99984C4.30729 8.23173 5.00967 6.53603 6.25991 5.28579C7.51016 4.03555 9.20585 3.33317 10.974 3.33317C12.7421 3.33317 14.4378 4.03555 15.688 5.28579C16.9382 6.53603 17.6406 8.23173 17.6406 9.99984ZM10.974 14.9998C12.3 14.9998 13.5718 14.4731 14.5095 13.5354C15.4472 12.5977 15.974 11.3259 15.974 9.99984C15.974 8.67375 15.4472 7.40199 14.5095 6.4643C13.5718 5.52662 12.3 4.99984 10.974 4.99984C9.64788 4.99984 8.37611 5.52662 7.43842 6.4643C6.50074 7.40199 5.97396 8.67375 5.97396 9.99984C5.97396 11.3259 6.50074 12.5977 7.43842 13.5354C8.37611 14.4731 9.64788 14.9998 10.974 14.9998Z" fill="black"/>
                                </svg>'>
            ...
            <!-- Jawaban -->
            <div class="answers-container" id="multiple-choice-6" data-extra-id="multiple-choice-6" style="display: block; margin-top: 20px;" data-answer-index="4">
                <div id="answers-container-6">
                    <!-- Answer Group -->
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            <button class="btn status-button me-2" onclick="toggleAnswerStatus(this)" style="border: none;">
                                <!-- Ikon SVG Silang -->
                            ...
                            <label class="answer-label me-2">A.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="int">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">B.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="float">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">D.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Boolean">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                ...
                <div class="container mt-3">
                    <div>
                        <button class="btn add-answer-btn" onclick="addAnswer('answers-container-6', 'multiple-choice-6')" id="add-answer-button" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="add-answer-icon">
                                <path d="M9.28125 7.46875V0.25H7.21875V7.46875H0V9.53125H7.21875V16.75H9.28125V9.53125H16.5V7.46875H9.28125Z" fill="#0056D2"/>
                            </svg>
                            <span class="add-answer-text">Tambah jawaban</span>
            ...
            <div class="answers-container" id="essay-6" style="display: none;">
                <textarea class="form-control textarea-jawaban" placeholder="Masukkan jawaban"></textarea>
            </div>
        </div>
        <div class="card mb-3">
            ...
            <div class="question-row">
                <!-- Nomor Pertanyaan -->
                <label class="question-number">7.</label>

                <div class="textarea-container" data-group="1">
                    <textarea class="form-control question-textarea" rows="4" placeholder="Masukkan pertanyaan">Berapa ukuran memori yang digunakan oleh tipe data int di Java?</textarea>
                    <div id="imagePreviewContainer"
                        class="image-preview-container"
                        style="
                            position: absolute;
                ...
                <div class="question-options">
                    <!-- Dropdown Pilihan Ganda / Esai -->
                    <div class="question-type-container">
                        <button id="dropdown-toggle-7" class="dropdown-toggle" style="border: 1px solid #ccc;">
                            <span class="dropdown-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    <path d="M2.64062 9.99984C2.64062 14.6023 6.37146 18.3332 10.974 18.3332C15.5765 18.3332 19.3073 14.6023 19.3073 9.99984C19.3073 5.39734 15.5765 1.6665 10.974 1.6665C6.37146 1.6665 2.64062 5.39734 2.64062 9.99984ZM17.6406 9.99984C17.6406 11.7679 16.9382 13.4636 15.688 14.7139C14.4378 15.9641 12.7421 16.6665 10.974 16.6665C9.20585 16.6665 7.51016 15.9641 6.25991 14.7139C5.00967 13.4636 4.30729 11.7679 4.30729 9.99984C4.30729 8.23173 5.00967 6.53603 6.25991 5.28579C7.51016 4.03555 9.20585 3.33317 10.974 3.33317C12.7421 3.33317 14.4378 4.03555 15.688 5.28579C16.9382 6.53603 17.6406 8.23173 17.6406 9.99984ZM10.974 14.9998C12.3 14.9998 13.5718 14.4731 14.5095 13.5354C15.4472 12.5977 15.974 11.3259 15.974 9.99984C15.974 8.67375 15.4472 7.40199 14.5095 6.4643C13.5718 5.52662 12.3 4.99984 10.974 4.99984C9.64788 4.99984 8.37611 5.52662 7.43842 6.4643C6.50074 7.40199 5.97396 8.67375 5.97396 9.99984C5.97396 11.3259 6.50074 12.5977 7.43842 13.5354C8.37611 14.4731 9.64788 14.9998 10.974 14.9998Z" fill="black" />
                                </svg>
                        ...
                        <ul id="dropdown-menu-7" class="dropdown-menu">
                            <li data-value="multiple-choice" data-icon='
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    <path d="M2.64062 9.99984C2.64062 14.6023 6.37146 18.3332 10.974 18.3332C15.5765 18.3332 19.3073 14.6023 19.3073 9.99984C19.3073 5.39734 15.5765 1.6665 10.974 1.6665C6.37146 1.6665 2.64062 5.39734 2.64062 9.99984ZM17.6406 9.99984C17.6406 11.7679 16.9382 13.4636 15.688 14.7139C14.4378 15.9641 12.7421 16.6665 10.974 16.6665C9.20585 16.6665 7.51016 15.9641 6.25991 14.7139C5.00967 13.4636 4.30729 11.7679 4.30729 9.99984C4.30729 8.23173 5.00967 6.53603 6.25991 5.28579C7.51016 4.03555 9.20585 3.33317 10.974 3.33317C12.7421 3.33317 14.4378 4.03555 15.688 5.28579C16.9382 6.53603 17.6406 8.23173 17.6406 9.99984ZM10.974 14.9998C12.3 14.9998 13.5718 14.4731 14.5095 13.5354C15.4472 12.5977 15.974 11.3259 15.974 9.99984C15.974 8.67375 15.4472 7.40199 14.5095 6.4643C13.5718 5.52662 12.3 4.99984 10.974 4.99984C9.64788 4.99984 8.37611 5.52662 7.43842 6.4643C6.50074 7.40199 5.97396 8.67375 5.97396 9.99984C5.97396 11.3259 6.50074 12.5977 7.43842 13.5354C8.37611 14.4731 9.64788 14.9998 10.974 14.9998Z" fill="black"/>
                                </svg>'>
            ...
            <!-- Jawaban -->
            <div class="answers-container" id="multiple-choice-7" data-extra-id="multiple-choice-7" style="display: block; margin-top: 20px;" data-answer-index="4">
                <div id="answers-container-7">
                    <!-- Answer Group -->
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            <button class="btn status-button me-2" onclick="toggleAnswerStatus(this)" style="border: none;">
                               <!-- Ikon Centang -->
                            ...
                            <label class="answer-label me-2">A.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="4 byte">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">B.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="8 byte">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">C.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="2 byte">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">D.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="1 byte">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                ...
                <div class="container mt-3">
                    <div>
                        <button class="btn add-answer-btn" onclick="addAnswer('answers-container-7', 'multiple-choice-7')" id="add-answer-button" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="add-answer-icon">
                                <path d="M9.28125 7.46875V0.25H7.21875V7.46875H0V9.53125H7.21875V16.75H9.28125V9.53125H16.5V7.46875H9.28125Z" fill="#0056D2"/>
                            </svg>
                            <span class="add-answer-text">Tambah jawaban</span>
            ...
            <div class="answers-container" id="essay-7" style="display: none;">
                <textarea class="form-control textarea-jawaban" placeholder="Masukkan jawaban"></textarea>
            </div>
        </div>
        <div class="card mb-3">
            ...
            <div class="question-row">
                <!-- Nomor Pertanyaan -->
                <label class="question-number">8.</label>

                <div class="textarea-container" data-group="1">
                    <textarea class="form-control question-textarea" rows="4" placeholder="Masukkan pertanyaan">Apa tujuan dari keyword public dalam deklarasi kelas di Java?</textarea>
                    <div id="imagePreviewContainer"
                        class="image-preview-container"
                        style="
                            position: absolute;
                ...
                <div class="question-options">
                    <!-- Dropdown Pilihan Ganda / Esai -->
                    <div class="question-type-container">
                        <button id="dropdown-toggle-8" class="dropdown-toggle" style="border: 1px solid #ccc;">
                            <span class="dropdown-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    <path d="M2.64062 9.99984C2.64062 14.6023 6.37146 18.3332 10.974 18.3332C15.5765 18.3332 19.3073 14.6023 19.3073 9.99984C19.3073 5.39734 15.5765 1.6665 10.974 1.6665C6.37146 1.6665 2.64062 5.39734 2.64062 9.99984ZM17.6406 9.99984C17.6406 11.7679 16.9382 13.4636 15.688 14.7139C14.4378 15.9641 12.7421 16.6665 10.974 16.6665C9.20585 16.6665 7.51016 15.9641 6.25991 14.7139C5.00967 13.4636 4.30729 11.7679 4.30729 9.99984C4.30729 8.23173 5.00967 6.53603 6.25991 5.28579C7.51016 4.03555 9.20585 3.33317 10.974 3.33317C12.7421 3.33317 14.4378 4.03555 15.688 5.28579C16.9382 6.53603 17.6406 8.23173 17.6406 9.99984ZM10.974 14.9998C12.3 14.9998 13.5718 14.4731 14.5095 13.5354C15.4472 12.5977 15.974 11.3259 15.974 9.99984C15.974 8.67375 15.4472 7.40199 14.5095 6.4643C13.5718 5.52662 12.3 4.99984 10.974 4.99984C9.64788 4.99984 8.37611 5.52662 7.43842 6.4643C6.50074 7.40199 5.97396 8.67375 5.97396 9.99984C5.97396 11.3259 6.50074 12.5977 7.43842 13.5354C8.37611 14.4731 9.64788 14.9998 10.974 14.9998Z" fill="black" />
                                </svg>
                        ...
                        <ul id="dropdown-menu-8" class="dropdown-menu">
                            <li data-value="multiple-choice" data-icon='
                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    <path d="M2.64062 9.99984C2.64062 14.6023 6.37146 18.3332 10.974 18.3332C15.5765 18.3332 19.3073 14.6023 19.3073 9.99984C19.3073 5.39734 15.5765 1.6665 10.974 1.6665C6.37146 1.6665 2.64062 5.39734 2.64062 9.99984ZM17.6406 9.99984C17.6406 11.7679 16.9382 13.4636 15.688 14.7139C14.4378 15.9641 12.7421 16.6665 10.974 16.6665C9.20585 16.6665 7.51016 15.9641 6.25991 14.7139C5.00967 13.4636 4.30729 11.7679 4.30729 9.99984C4.30729 8.23173 5.00967 6.53603 6.25991 5.28579C7.51016 4.03555 9.20585 3.33317 10.974 3.33317C12.7421 3.33317 14.4378 4.03555 15.688 5.28579C16.9382 6.53603 17.6406 8.23173 17.6406 9.99984ZM10.974 14.9998C12.3 14.9998 13.5718 14.4731 14.5095 13.5354C15.4472 12.5977 15.974 11.3259 15.974 9.99984C15.974 8.67375 15.4472 7.40199 14.5095 6.4643C13.5718 5.52662 12.3 4.99984 10.974 4.99984C9.64788 4.99984 8.37611 5.52662 7.43842 6.4643C6.50074 7.40199 5.97396 8.67375 5.97396 9.99984C5.97396 11.3259 6.50074 12.5977 7.43842 13.5354C8.37611 14.4731 9.64788 14.9998 10.974 14.9998Z" fill="black"/>
                                </svg>'>
            ...
            <!-- Jawaban -->
            <div class="answers-container" id="multiple-choice-8" data-extra-id="multiple-choice-8" style="display: block; margin-top: 20px;" data-answer-index="4">
                <div id="answers-container-8">
                    <!-- Answer Group -->
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            <button class="btn status-button me-2" onclick="toggleAnswerStatus(this)" style="border: none;">
                                <!-- Ikon SVG Silang -->
                            ...
                            <label class="answer-label me-2">A.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Menandakan bahwa kelas tersebut hanya dapat diakses dalam paket yang sama">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">B.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Menandakan bahwa kelas tersebut dapat diakses dari mana saja">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">C.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Membaca data dari pengguna Menandakan bahwa kelas tersebut tidak dapat diubah">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                        ...
                        <div class="answer-input-group d-flex align-items-center mb-2">
                            ...
                            <label class="answer-label me-2">D.</label>
                            <div class="input-wrapper position-relative">
                                <input type="text" class="form-control pr-5" placeholder="Masukkan jawaban" value="Menandakan bahwa kelas tersebut adalah kelas abstrak">
                                <button class="btn image-button position-absolute end-0 top-50 translate-middle-y" style="border: none;" onclick="document.getElementById('image-upload').click();">
                                    <!-- Ikon Upload -->
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
                                        <path d="M4.16732 4.97248H3.93147V5.20833V17.7083V17.9442H4.16732H12.2648V19.5558H4.16732C3.14862 19.5558 2.31983 18.727 2.31983 17.7083V5.20833C2.31983 4.18963 3.14862 3.36085 4.16732 3.36085H17.709C18.7277 3.36085 19.5565 4.18963 19.5565 5.20833V12.2642H17.9448V5.20833V4.97248H17.709H4.16732Z" fill="#4A5568" stroke="#4A5568" stroke-width="0.471698"/>
                ...
                <div class="container mt-3">
                    <div>
                        <button class="btn add-answer-btn" onclick="addAnswer('answers-container-8', 'multiple-choice-8')" id="add-answer-button" >
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none" class="add-answer-icon">
                                <path d="M9.28125 7.46875V0.25H7.21875V7.46875H0V9.53125H7.21875V16.75H9.28125V9.53125H16.5V7.46875H9.28125Z" fill="#0056D2"/>
                            </svg>
                            <span class="add-answer-text">Tambah jawaban</span>
            ...
            <div class="answers-container" id="essay-8" style="display: none;">
                <textarea class="form-control textarea-jawaban" placeholder="Masukkan jawaban"></textarea>
            </div>
        </div>
...
document.querySelectorAll(".question-type-container").forEach(function (container, index) {
    const dropdownToggle = container.querySelector(".dropdown-toggle");
    const dropdownMenu = container.querySelector(".dropdown-menu");
    const multipleChoice = document.getElementById(`multiple-choice-${index + 1}`);
    const essay = document.getElementById(`essay-${index + 1}`);
...
let answerIndex = 4; // Dimulai dari "C" (A=0, B=1, C=2)
const maxAnswerIndex = 4; // Batas maksimum jawaban, yaitu "E"

function addAnswer(containerId, parentContainerId) {
    const answersContainer = document.getElementById(containerId);
    const parentContainer = document.querySelector(`[data-extra-id="${parentContainerId}"]`); // Cari elemen berdasarkan data-extra-id

    if (!answersContainer || !parentContainer) {
        console.error(`Container dengan ID "${containerId}" atau data-extra-id "${parentContainerId}" tidak ditemukan.`);
        return;
    }

    // Ambil indeks jawaban dari atribut data
    let answerIndex = parseInt(parentContainer.getAttribute('data-answer-index'), 10);

    if (answerIndex > maxAnswerIndex) {
        alert("Anda sudah mencapai jumlah jawaban maksimum!");
        return;
    }
    ...
    parentContainer.setAttribute('data-answer-index', answerIndex + 1);
};
