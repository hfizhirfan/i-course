...
<div class="search-container">
    <div class="container search d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
            ...
            <span class="user-name">Budiono Siregar</span> <!-- Nama pengguna -->
        </div>
    </div>
    ...
    <div class="card">
        <div class="row g-3">
            <div class="col-md-6 d-flex align-items-center">
                ...
                <input type="text" class="form-control" id="userId" value="US100235" readonly>
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Nama Lengkap</label>
                <input type="text" class="form-control" id="userId" name="nama_lengkap" value="Budi Santoso" readonly>
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Nomor Telepon</label>
                <input type="text" class="form-control" id="phone" name="nomor_telepon" value="0812-3456-7890" readonly>
            </div>
            <div class="col-md-6 d-flex align-items-center">
                <label for="userId" class="form-label me-3">Email</label>
                <input type="email" class="form-control" id="email" name="email" value="budisantoso@email.com" readonly >
            </div>
            <div class="col-md-6 d-flex align-items-center">
            ...
            <div class="col-md-6 d-flex align-items-center">
                ...
                <div id="photoPopup" class="popup">
                    <div class="popup-content">
                        ...
                        <img src="{{ Vite::asset('resources/images/budiono siregar.png') }}" alt="Foto Budiono Siregar">
                    </div>
                </div>
            </div>
            <div class="row g-3">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    ...
                    <input type="text" class="form-control" id="twitter" name="twitter" placeholder="Tulis akun Twitter" value="@budionosiregar" readonly>
                </div>
                <div class="col-md-6 d-flex align-items-center">
                    <label for="facebook" class="form-label me-3">Facebook</label>
                    <input type="text" class="form-control" id="facebook" name="facebook" placeholder="Tulis akun Facebook" value="Budiono Siregar" readonly>
                </div>

                <!-- Instagram dan LinkedIn -->
                <div class="col-md-6 d-flex align-items-center">
                    <label for="instagram" class="form-label me-3">Instagram</label>
                    <input type="text" class="form-control" id="instagram" name="instagram" placeholder="Tulis akun Instagram" value="@budiisiregar" readonly>
                </div>
                <div class="col-md-6 d-flex align-items-center">
                    <label for="linkedin" class="form-label me-3">LinkedIn</label>
                    <input type="text" class="form-control" id="linkedin" name="linkedin" placeholder="Tulis akun LinkedIn" value="Budiono Siregar" readonly>
                </div>
            </div>
    ...
    <div class="card">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="berlangsung" role="tabpanel">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <h6 class="course-name">Pemrograman Java untuk Pemula</h6>
                    </div>
                    <div class="col-md-6 d-flex align-items-center">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <h6 class="course-name">Rest API dengan Golang</h6>
                    </div>
                    <div class="col-md-6 d-flex align-items-center">
                        <div class="progress" style="flex-grow: 1; margin-right: 10px;">
            ...
            <div class="tab-pane fade" id="selesai" role="tabpanel">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <h6 class="course-name">HTML, CSS, dan JavaScript untuk Pemula</h6>
                    </div>
                    <div class="col-md-6 d-flex align-items-center">
                        <div class="progress" style="flex-grow: 1; margin-right: 10px;">
    ...
    <div class="card">
        <div class="review-card" data-rating="4" data-photo="false">
            <div class="d-flex align-items-center mb-3">
                <div class="me-3">
                    <img src="{{ Vite::asset('resources/images/profile.png') }}" alt="Profile Picture" style="width: 60px; height: 60px; border-radius: 50%; object-fit: cover;">
                </div>
                <div class="d-flex align-items-center mb-3 review-header">
                    <h5 class="mb-0 custom-h5">Budiono Siregar</h5>
            ...
            <div>
                ...
                <p class="text-course-title">HTML, CSS, dan JavaScript untuk Pemula</p>
            </div>
        </div>
    </div>
</div>
