<div class="container my-4">
    ...
    <div class="video-container">
        <video id="custom-video1" width="100%">
            <source src="{{ Vite::asset('resources/images/video12.mp4') }}" type="video/mp4">
            Your browser does not support the video tag.
        </video>
        <div class="video-controls">
            <button id="play-pause-btn1">
                <i class="bi bi-play-fill"></i>
            </button>
            <span id="current-time1">0:00</span> / <span id="duration1">0:00</span>
            <input id="progress-bar1" type="range" value="0" min="0" max="100">
            <button id="speed-btn1">1x</button>
            <button id="fullscreen-btn1">⛶</button>
        </div>
    </div>
    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link active" id="nav-umum3-tab" data-bs-toggle="tab" data-bs-target="#nav-umum3" type="button" role="tab">Umum</button>
            <button class="nav-link" id="nav-catatan3-tab" data-bs-toggle="tab" data-bs-target="#nav-catatan3" type="button" role="tab">Catatan</button>
            <button class="nav-link" id="nav-forum3-tab" data-bs-toggle="tab" data-bs-target="#nav-forum3" type="button" role="tab">Forum</button>
            <button class="nav-link" id="nav-konten3-tab" data-bs-toggle="tab" data-bs-target="#nav-konten3" type="button" role="tab">Konten</button>
        </div>
    </nav>
    ...
    <div class="tab-content mt-4" id="nav-tabContent">
        <!-- Tab Umum -->
        <div class="tab-pane fade show active" id="nav-umum3" role="tabpanel">
            <h4 class="heading-custom">Instalasi JDK dan pengaturan IDE (NetBeans, Eclipse, IntelliJ)
            </h4>
        ...
        <!-- Tab Catatan -->
        <div class="tab-pane fade" id="nav-catatan3" role="tabpanel">
            <div class="container mt-3" style="margin-bottom: 40px;">
                <!-- Input Catatan -->
                <div class="position-relative mb-3">
                    <!-- Input Field -->
                    <input id="note-input2" type="text" class="form-control rounded custom-height" placeholder="Tambah catatan baru" aria-label="Tambah catatan">

                    <!-- SVG Button di dalam Input -->
                    <button id="add-note-btn2" class="btn position-absolute top-50 translate-middle-y p-0" style="right: 10px; background: none; border: none;" type="button">
                        <!-- Icon Button -->
            ...
            <div id="card-container">
                ...
                <div id="notes-container3" class="card mb-4 shadow-sm" data-materi="modul1" data-waktu="1hari">
        ...
        <!-- Tab Forum -->
        <div class="tab-pane fade" id="nav-forum3" role="tabpanel">
            <div class="container mt-5 custom-container">
                ...
                <div class="message-input position-relative">
                    ...
                    <button class="rounded-post-btn" id="post-btn3">Post</button>
                </div>
            </div>
            <div id="discussion-container3" class="container mt-5" style="display: none;">
        ...
        <!-- Tab Konten -->
        <div class="tab-pane fade" id="nav-konten3" role="tabpanel">
            <div class="container mt-5">
                <!-- Card Material -->
                <div class="material-card">
                    ...
                    <div class="material-content">
                        <h5>Instalasi JDK dan pengaturan IDE (NetBeans, Eclipse, IntelliJ)
                        </h5>
                        <p class="mb-0">
                    ...
                    <div class="download-section">
                        <a href="{{ asset('images/video12.mp4') }}" class="text-decoration-none text-dark fw-semibold" download class="download-button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
...
#current-time1, #duration1 {
    font-size: 14px;
}
</style>
<script>
document.addEventListener('DOMContentLoaded', () => {
    const video = document.getElementById('custom-video1');
    const playPauseButton = document.getElementById('play-pause-btn1');
    const progressBar = document.getElementById('progress-bar1');
    const currentTimeDisplay = document.getElementById('current-time1');
    const durationDisplay = document.getElementById('duration1');
    const speedButton = document.getElementById('speed-btn1');
    const fullscreenButton = document.getElementById('fullscreen-btn1');
...
document.addEventListener('DOMContentLoaded', () => {
    // Elemen dengan ID unik untuk content-video2
    const addNoteBtn = document.getElementById('add-note-btn3'); // Tombol tambah catatan
    const noteInput = document.getElementById('note-input3'); // Input field untuk isi catatan
    const notesContainer = document.getElementById('notes-container3'); // Tempat menampung catatan

    // Fungsi untuk format waktu (misalnya menit:detik dari video)
    function getFormattedTime(currentTime = 0) {
    ...
    addNoteBtn.addEventListener('click', () => {
        ...
        const formattedTime = getFormattedTime(120); // Contoh waktu (misalnya 120 detik)
        ...
        newNote.innerHTML = `
            <div class="card-body">
                <div class="d-flex align-items-center mb-2">
                    <span class="custom-badge">${formattedTime}</span>
                    <div>
                        <strong>Modul 1: Pengantar dan Dasar-dasar Pemrograman Java</strong>
                        <p class="text-muted m-0" style="font-size: 0.875rem;">Instalasi JDK dan pengaturan IDE (NetBeans, Eclipse, IntelliJ)</p>
                    </div>
        ...
        const deleteButtons = newNote.querySelectorAll('.btn-delete');
