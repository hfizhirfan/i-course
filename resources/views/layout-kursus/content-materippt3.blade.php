<div class="container my-4">
    <!-- Video Langsung -->
    <div class="mb-4">
        <iframe src="{{ asset('PPT materi Unocos 3.pdf') }}#toolbar=0" width="100%" height="600px"
    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            <button class="nav-link active" id="nav-umum9-tab" data-bs-toggle="tab" data-bs-target="#nav-umum9" type="button" role="tab">Umum</button>
            <button class="nav-link" id="nav-forum9-tab" data-bs-toggle="tab" data-bs-target="#nav-forum9" type="button" role="tab">Forum</button>
            <button class="nav-link" id="nav-konten9-tab" data-bs-toggle="tab" data-bs-target="#nav-konten9" type="button" role="tab">Konten</button>
        </div>
    </nav>
    ...
    <div class="tab-content mt-4" id="nav-tabContent">
        <!-- Tab Umum -->
        <div class="tab-pane fade show active" id="nav-umum9" role="tabpanel">
            <h4 class="heading-custom">Pemrograman Java untuk Pemula
            </h4>
        ...
        <!-- Tab Forum -->
        <div class="tab-pane fade" id="nav-forum9" role="tabpanel">
            <div class="container mt-5 custom-container">
                ...
                <div class="message-input position-relative">
                    ...
                    <button class="rounded-post-btn" id="post-btn9">Post</button>
                </div>
            </div>
            <div id="discussion-container9" class="container mt-5" style="display: none;">
        ...
        <!-- Tab Konten -->
        <div class="tab-pane fade" id="nav-konten9" role="tabpanel">
            <div class="container mt-5">
                <!-- Card Material -->
                <div class="material-card">
                    ...
                    <div class="material-content">
                        <h5>Pemrograman Java untuk Pemula</h5>
                        <p class="mb-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
                                <path d="M6.6378 9.74383H12.3615V8.95217H6.6378V9.74383ZM6.6378 11.936H12.3615V11.1443H6.6378V11.936ZM6.6378 14.1289H9.98655V13.3372H6.6378V14.1289ZM5.23655 16.625C4.87238 16.625 4.56838 16.5031 4.32455 16.2593C4.08072 16.0154 3.95854 15.7112 3.95801 15.3465V3.65354C3.95801 3.28937 4.08019 2.98538 4.32455 2.74154C4.56891 2.49771 4.87317 2.37553 5.23734 2.375H11.4788L15.0413 5.9375V15.3465C15.0413 15.7106 14.9194 16.0149 14.6756 16.2593C14.4318 16.5036 14.1272 16.6255 13.762 16.625H5.23655ZM11.083 6.33333V3.16667H5.23734C5.11542 3.16667 5.00354 3.21733 4.90167 3.31867C4.79981 3.42 4.74915 3.53162 4.74967 3.65354V15.3465C4.74967 15.4678 4.80034 15.5795 4.90167 15.6813C5.00301 15.7832 5.11463 15.8339 5.23655 15.8333H13.7628C13.8842 15.8333 13.9958 15.7827 14.0977 15.6813C14.1995 15.58 14.2502 15.4681 14.2497 15.3457V6.33333H11.083Z" fill="#4A5568"/>
                              </svg>
                            PDF
                        </p>
                    </div>
                    ...
                    <div class="download-section">
                        <a href="{{ asset('PPT materi Unocos 3.pdf') }}"
                           class="text-decoration-none text-dark fw-semibold"
                           download="PPT_materi_Unocos.pdf">
